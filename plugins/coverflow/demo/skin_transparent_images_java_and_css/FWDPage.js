...
var sValues = [86, 120, 60, 230, 93, 0, 20, 30, 0, true, 0];
...
function onThumbPressedHandler(e)
{
	...
	if(e.id == 0){
		...
		coverflowHeight = 538;
		setupCoverflow();
		sValues = [86, 120, 60, 230, 93, 0, 20, 30, 0, true, 0];
	}else if(e.id == 1){
		body_el.appendChild(playlist1SingleCat_el);
		coverflowHeight = 538;
		setupCoverflow1();
		sValues = [80, 120, 60, 230, 145, 3, 20, 30, 3, true, 0];
	}
