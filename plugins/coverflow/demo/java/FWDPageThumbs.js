/* FWDR3DCovPageThumbs */
(function (window){
var FWDR3DCovPageThumbs = function(props_obj){
		
		var self = this;
		var prototype = FWDR3DCovPageThumbs.prototype;
		...
		this.setupThumbs = function()
		{
			...
			{
				FWDR3DCovPageThumb.setPrototype();
				
				thumb = new FWDR3DCovPageThumb(i, 180, 119, self.imagesPath_ar[i] + "N.jpg", self.imagesPath_ar[i] + "S.jpg");
				thumb.addListener(FWDR3DCovPageThumb.CLICK, self.onThumbClick);
		...
		this.onThumbClick = function(e)
		{
			...
			self.dispatchEvent(FWDR3DCovPageThumb.CLICK, {id:self.curId});
		};
	...
	/* set prototype */
	FWDR3DCovPageThumbs.setPrototype = function(){
		FWDR3DCovPageThumbs.prototype = new FWDR3DCovDisplayObject("div");
	};
	
	FWDR3DCovPageThumbs.CLICK = "onClick";

	FWDR3DCovPageThumbs.prototype = null;
	window.FWDR3DCovPageThumbs = FWDR3DCovPageThumbs;
}(window));