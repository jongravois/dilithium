/* FWDR3DCovSimpleButtonUrl */
(function (window){
var FWDR3DCovSimpleButtonUrl = function(bWidth, bHeight, nImgUrl, sImgUrl)
{
		var self = this;
		var prototype = FWDR3DCovSimpleButtonUrl.prototype;
		...
		this.onClick = function(e){
			self.dispatchEvent(FWDR3DCovSimpleButtonUrl.CLICK);
		};
		...
		this.enable = function()
		{
			...
			FWDR3DCovModTweenMax.to(self.n_do, .1, {alpha:1, ease:Expo.easeOut});
			FWDR3DCovModTweenMax.to(self.s_do, .1, {alpha:1, ease:Expo.easeOut});
		};
		...
		this.disable = function()
		{
			...
			FWDR3DCovModTweenMax.to(self.n_do, .1, {alpha:.5, ease:Expo.easeOut});
			FWDR3DCovModTweenMax.to(self.s_do, .1, {alpha:.5, ease:Expo.easeOut});
		};
		...
		this.destroy = function(){
			...
			self = null;
			prototype = null;
			FWDR3DCovSimpleButtonUrl.prototype = null;
		};
	...
	/* set prototype */
	FWDR3DCovSimpleButtonUrl.setPrototype = function(){
		FWDR3DCovSimpleButtonUrl.prototype = new FWDR3DCovDisplayObject("div");
	};
	
	FWDR3DCovSimpleButtonUrl.CLICK = "onClick";
	
	FWDR3DCovSimpleButtonUrl.prototype = null;
	window.FWDR3DCovSimpleButtonUrl = FWDR3DCovSimpleButtonUrl;
}(window));