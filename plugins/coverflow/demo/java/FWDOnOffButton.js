/* FWDR3DCovOnOffButton */
(function (window){
var FWDR3DCovOnOffButton = function(bWidth, bHeight, btnWidth, skinPath, value)
{
		var self = this;
		var prototype = FWDR3DCovOnOffButton.prototype;
		...
		{
			self.bgDO = new FWDR3DCovSimpleDisplayObject("img");
			...
			self.btnDO = new FWDR3DCovDisplayObject("div");
			self.addChild(self.btnDO);
			
			self.btnDO.setWidth(btnWidth);
			self.btnDO.setHeight(bHeight);
			
			self.btnSDO = new FWDR3DCovSimpleDisplayObject("img");
			...
			self.btnNDO = new FWDR3DCovSimpleDisplayObject("img");
		...
		this.onMouseOver = function(e)
		{
			...
			{
				FWDR3DCovModTweenMax.to(self.btnNDO, .4, {alpha:0, ease:Expo.easeOut});
			}
		};
		...
		this.onMouseOut = function(e)
		{
			if (!e.pointerType || e.pointerType == e.MSPOINTER_TYPE_MOUSE)
			{
				FWDR3DCovModTweenMax.to(self.btnNDO, .4, {alpha:1, ease:Expo.easeOut});
			}
		};
		...
		this.onMouseUp = function(e)
		{
			...
			FWDR3DCovModTweenMax.to(self.btnDO, .2, {x:self.btnCurX, ease:Expo.easeOut});
			
			if (self.value != newVal)
			{
				self.dispatchEvent(FWDR3DCovOnOffButton.CHANGE, {value:newVal});
			}
		...
		this.destroy = function()
		{
			...
			self = null;
			prototype = null;
			FWDR3DCovOnOffButton.prototype = null;
		};
	...
	/* set prototype */
	FWDR3DCovOnOffButton.setPrototype = function(){
		FWDR3DCovOnOffButton.prototype = new FWDR3DCovDisplayObject("div");
	};
	
	FWDR3DCovOnOffButton.CHANGE = "onChange";
	
	FWDR3DCovOnOffButton.prototype = null;
	window.FWDR3DCovOnOffButton = FWDR3DCovOnOffButton;
}(window));