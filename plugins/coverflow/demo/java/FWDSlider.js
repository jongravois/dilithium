...
(function(window)
{
	var FWDR3DCovSlider = function(propsObj)
	{
		var self = this;
		var prototype = FWDR3DCovSlider.prototype;
		...
		{
			self.sliderTrackDO = new FWDR3DCovDisplayObject("div");
			...
			self.sliderTrackLeftDO = new FWDR3DCovSimpleDisplayObject("img");
			...
			self.sliderTrackCenterDO = new FWDR3DCovSimpleDisplayObject("div");
			...
			self.sliderTrackRightDO = new FWDR3DCovSimpleDisplayObject("img");
		...
		{
			self.sliderProgressDO = new FWDR3DCovDisplayObject("div");
			...
			self.sliderProgressLeftDO = new FWDR3DCovSimpleDisplayObject("img");
			...
			self.sliderProgressCenterDO = new FWDR3DCovSimpleDisplayObject("div");
		...
		{
			self.sliderHandlerDO = new FWDR3DCovDisplayObject("div");
			...
			self.sliderHandlerSDO = new FWDR3DCovSimpleDisplayObject("img");
			...
			self.sliderHandlerNDO = new FWDR3DCovSimpleDisplayObject("img");
		...
		this.onScrollMouseOver = function()
		{
			...
			FWDR3DCovModTweenMax.to(self.sliderHandlerNDO, .8, {alpha:0, ease : Expo.easeOut});
		};
		...
		this.onScrollMouseOut = function()
		{
			...
			FWDR3DCovModTweenMax.to(self.sliderHandlerNDO, .8, {alpha:1, ease : Expo.easeOut});;
		};
		...
		this.onScrollMove = function(e)
		{
			...
			if (newValue != self.value)
			{
				...
				self.dispatchEvent(FWDR3DCovSlider.CHANGE, {value:self.value});
			}
		};
		...
		this.destroy = function()
		{
			...
			FWDR3DCovModTweenMax.killTweensOf(self.sliderHandlerNDO);
			...
			self = null;
			prototype = null;
			FWDR3DCovSlider.prototype = null;
		};
	...
	/* set prototype */
	FWDR3DCovSlider.setPrototype = function()
	{
		FWDR3DCovSlider.prototype = new FWDR3DCovDisplayObject("div");
	};

	FWDR3DCovSlider.CHANGE = "onChange";

	FWDR3DCovSlider.prototype = null;
	window.FWDR3DCovSlider = FWDR3DCovSlider;
}(window));