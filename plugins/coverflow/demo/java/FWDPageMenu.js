/* FWDR3DCovPageMenu */
(function (window){
var FWDR3DCovPageMenu = function(props_obj){
		
		var self = this;
		var prototype = FWDR3DCovPageMenu.prototype;
		...
		this.setupButtons = function()
		{
			...
			for(var i=0; i<self.totalButtons; i++){
				...
				FWDR3DCovPageMenuButton.setPrototype();
				button = new FWDR3DCovPageMenuButton(self.menuLabels_ar[i*2], self.menuLabels_ar[i*2 + 1], disableButton_bl);
				button.id = i;
				button.addListener(FWDR3DCovPageMenuButton.CLICK, self.buttonClickHandler);
		...
		this.buttonClickHandler = function(e){
			self.dispatchEvent(FWDR3DCovPageMenuButton.CLICK, {id:e.target.id});
		};
	...
	/* set prototype */
	FWDR3DCovPageMenu.setPrototype = function(){
		FWDR3DCovPageMenu.prototype = new FWDR3DCovDisplayObject("div");
	};
	
	FWDR3DCovPageMenu.CLICK = "onClick";

	FWDR3DCovPageMenu.prototype = null;
	window.FWDR3DCovPageMenu = FWDR3DCovPageMenu;
}(window));