...
var FWDResetButton = function(bWidth, bHeight, skinPath)
{
		...
		this.setupMainContainers = function()
		{
			...
			this.p_do = new FWDR3DCovSimpleDisplayObject("img");
		...
		this.onMouseOut = function(e)
		{
			if (!e.pointerType || e.pointerType == e.MSPOINTER_TYPE_MOUSE)
			{
				...
				FWDR3DCovModTweenMax.to(self.s_do, .9, {alpha:1, ease:Expo.easeOut});
			}
		};
		...
		this.onMouseDown = function(e)
		{
			if (!e.pointerType || e.pointerType == e.MSPOINTER_TYPE_MOUSE)
			{
				FWDR3DCovModTweenMax.to(self.s_do, .9, {alpha:0, ease:Expo.easeOut});
			}
		};
		...
		this.destroy = function()
		{
			...
			FWDR3DCovModTweenMax.killTweensOf(self.p_do);
	...
	FWDResetButton.setPrototype = function(){
		FWDResetButton.prototype = new FWDR3DCovDisplayObject("div");
	};
